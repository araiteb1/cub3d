...
/*   Updated: 2023/11/06 03:54:06 by araiteb          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	if (mlx_is_key_down(map_info->mlx, MLX_KEY_S))
// 		move_s(map_info, player);
// 	if (mlx_is_key_down(map_info->mlx, MLX_KEY_A))
// 		move_a(map_info, player);
// 	if (mlx_is_key_down(map_info->mlx, MLX_KEY_D))
// 		move_d(map_info, player);
// 	if (mlx_is_key_down(map_info->mlx, MLX_KEY_RIGHT))
// 		move_right(map_info, player);
// 	if (mlx_is_key_down(map_info->mlx, MLX_KEY_LEFT))
// 		move_left(map_info, player);
// 	if (mlx_is_key_down(map_info->mlx, MLX_KEY_ESCAPE))
// 		exit(1);
// }
